...
4. Repita as mesmas transformações do item (3.a e 3.b) considerando um pivô de
    coordenadas (0.5, 0.5,0.5). Ou seja, antes da escala e rotação o pivô deve ser trazido
    a origem e depois reestabelecido ao ponto original.
