...
Base code by: LUIZ GONZAGA DA SILVEIRA JUNIOR

List of exercises 1 - Exercise 5

5. Implemente uma câmera que gire em torno da origem (no plano xz), e se apertar as
    teclas de seta para esquerda e seta para a direita do teclado. Utilizar a glm::lookat
    para simplificar o trabalho


Use keys : right arrow or left arrow to manipulate the camera
...
int main()
{
    ...
    while (!glfwWindowShouldClose(g_window))
    {
        ...
        glm::vec3 pos;
        pos = (reverse) ? glm::vec3(camera_x, 0.0f, camera_z) : glm::vec3(-camera_x, 0.0f, camera_z);
